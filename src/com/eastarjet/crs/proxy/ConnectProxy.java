...
public class ConnectProxy extends AsyncTask {
...
//		socket = sock;
		...
		try
		{
			...
			String conStr="RCON2SVR";
			if(log.isInfoEnabled())log.info("send Hedaer="+conStr);
			readLine(targetSocket,buf);
			writeLine(targetSocket,buf,conStr);
